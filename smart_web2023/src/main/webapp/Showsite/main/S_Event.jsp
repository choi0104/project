                    ...
                    <c:forEach var="i" begin="${startNum}" end="${endNum}" >
						<c:if test="${not empty boardList[i-1]}"><!-- boardList에 저장된 데이터가 있는 경우 출력-->
                           	<td style="width: 237px;">
                           		<a href="S_Eventview.jsp?b_idx=${boardList[i-1].b_idx}"><img src="../siteimg/링크배경7.png" width="200px"height="150px"></a><br>
                               	<a href="S_Eventview.jsp?b_idx=${boardList[i-1].b_idx}"> ${boardList[i-1].title} </a><br>
