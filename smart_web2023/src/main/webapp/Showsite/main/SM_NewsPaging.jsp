...
<c:choose>
	...
	<c:otherwise><!-- 검색어가 없는 경우  -->
		...
		<c:if test="${News_pageNum > 5}">
			<a href="S_Manager.jsp?
			Notice_pageNum=${Notice_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=1&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=1&Free_pageBlock=${Free_pageBlock}">&lt;&lt;</a>
			&nbsp;
			<a href="S_Manager.jsp?
			Notice_pageNum=${Notice_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=${(News_pageBlock-2)*pages_pageBlock+1}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock-1}&Free_pageBlock=${Free_pageBlock}">이전</a>
		</c:if>
		...
		<c:forEach var="p" begin="${(News_pageBlock - 1)*pages_pageBlock +1}" end="${News_pageBlock*pages_pageBlock}">
			<c:if test="${p le News_total_pageNum}">
				<a href="S_Manager.jsp?
				Notice_pageNum=${Notice_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=${p}&Free_pageNum=${Free_pageNum}&
		...
		<c:if test="${News_total_pageNum > (News_pageBlock*pages_pageBlock)}">
			<a href="S_Manager.jsp?
			Notice_pageNum=${Notice_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=${(News_pageBlock*pages_pageBlock)+1}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock+1}&Free_pageBlock=${Free_pageBlock}">다음</a>
			&nbsp;
			<a href="S_Manager.jsp?
			Notice_pageNum=${Notice_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=${News_total_pageNum}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_last_pageBlock}&Free_pageBlock=${Free_pageBlock}">&gt;&gt;</a>
		</c:if>	
	</c:otherwise>
</c:choose>
