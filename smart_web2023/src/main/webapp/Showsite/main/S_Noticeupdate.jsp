    ...
    <div id="WriteLine">
        <div id="WritePage">
            <div class="container mt-5" >
                <h2 class="text-center mb-4">공지사항 게시글 수정</h2>
                <form name="frm_write" method="post" action="S_Noticeupdate_process.jsp" enctype="multipart/form-data">
				...
				<input type="hidden" name="writer" value="${member.member_name}">
                    ...
                    <div class="form-group" style="display:flex;">
						...
						<input style="margin-left: 230px" type="button" value="목록보기" onclick="location.href='S_Notice.jsp'">
                    </div>
