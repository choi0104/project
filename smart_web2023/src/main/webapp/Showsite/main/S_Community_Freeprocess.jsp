...
<%@ page import="ShowSite.Sfree_DTO, ShowSite.Sfree_DAO" %>
<%
	...
	//BoardDAO객체 생성해서 dto에Sfree_DAO 저장된 내용을 DB에 저장하기
	Sfree_DAO dao = new Sfree_DAO();
	...
	try{
		...
		int result = dao.insert(dto);//글등록 성공시 1반환, 실패시 0반환
			if(result == 1){
			response.sendRedirect("S_Manager.jsp");
			}
		}
	}catch(IOException e){
