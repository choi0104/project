...
<c:choose>
	...
	<c:otherwise><!-- 검색어가 없는 경우  -->
		...
		<c:if test="${Notice_pageNum > 5}">
			<a href="S_Manager.jsp?
			Notice_pageNum=1&Event_pageNum=${Event_pageNum}&News_pageNum=${News_pageNum}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=1&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock}&Free_pageBlock=${Free_pageBlock}">&lt;&lt;</a>
			&nbsp;
			<a href="S_Manager.jsp?
			Notice_pageNum=${(Notice_pageBlock-2)*pages_pageBlock+1}&Event_pageNum=${Event_pageNum}&News_pageNum=${News_pageNum}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock-1}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock}&Free_pageBlock=${Free_pageBlock}">이전</a>
		</c:if>
		...
		<c:forEach var="p" begin="${(Notice_pageBlock - 1)*pages_pageBlock +1}" end="${Notice_pageBlock*pages_pageBlock}">
			<c:if test="${p le Notice_total_pageNum}">
				<a href="S_Manager.jsp?
				Notice_pageNum=${p}&Event_pageNum=${Event_pageNum}&News_pageNum=${News_pageNum}&Free_pageNum=${Free_pageNum}&
		...
		<c:if test="${Notice_total_pageNum > (Notice_pageBlock*pages_pageBlock)}">
			<a href="S_Manager.jsp?
			Notice_pageNum=${(Notice_pageBlock*pages_pageBlock)+1}&Event_pageNum=${Event_pageNum}&News_pageNum=${News_pageNum}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_pageBlock + 1}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock}&Free_pageBlock=${Free_pageBlock}">다음</a>
			&nbsp;
			<a href="S_Manager.jsp?
			Notice_pageNum=${Notice_total_pageNum}&Event_pageNum=${Event_pageNum}&News_pageNum=${News_pageNum}&Free_pageNum=${Free_pageNum}&
			Notice_pageBlock=${Notice_last_pageBlock}&Event_pageBlock=${Event_pageBlock}&News_pageBlock=${News_pageBlock}&Free_pageBlock=${Free_pageBlock}">&gt;&gt;</a>
		</c:if>
	</c:otherwise>
</c:choose>
